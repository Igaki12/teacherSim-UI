...
function useMotionValue(initial) {
  ...
  if (isStatic) {
    const [, setLatest] = (0, import_react44.useState)(initial);
    (0, import_react44.useEffect)(() => value.on("change", setLatest), []);
  }
  return value;
}
  ...
  constructor(element, valueName, valueKeyframes, options) {
    ...
    const init = () => {
      ...
      this.removeAnimation = () => {
        const elementState = state2.get(element);
...
function omitReactElements(props) {
  return Object.fromEntries(
    Object.entries(props).filter(([key, value]) => {
      return value !== void 0 && key !== "children" && !(0, import_react68.isValidElement)(value);
    })
  );
}
...
function useImage(props) {
  ...
  const imageRef = (0, import_react79.useRef)(null);
...
function useCheckbox(props = {}) {
  ...
  const isFocusVisibleRef = (0, import_react92.useRef)(false);
...
var InFocusGuard = function InFocusGuard2(_ref2) {
  ...
  return import_react100.default.createElement(import_react100.Fragment, null, import_react100.default.createElement("div", {
    key: "guard-first",
    "data-focus-guard": true,
    "data-focus-auto-guard": true,
    style: hiddenGuard
  }), children, children && import_react100.default.createElement("div", {
    key: "guard-last",
    "data-focus-guard": true,
    "data-focus-auto-guard": true,
    style: hiddenGuard
...
var focusScope = (0, import_react103.createContext)(void 0);

// node_modules/react-focus-lock/dist/es2015/Lock.js
var emptyArray = [];
var FocusLock = (0, import_react104.forwardRef)(function FocusLockUI(props, parentRef) {
  var _extends2;
  var _useState = (0, import_react104.useState)(), realObserved = _useState[0], setObserved = _useState[1];
  var observed = (0, import_react104.useRef)();
  var isActive = (0, import_react104.useRef)(false);
  var originalFocusedElement = (0, import_react104.useRef)(null);
  var _useState2 = (0, import_react104.useState)({}), update = _useState2[1];
  ...
  var _useState3 = (0, import_react104.useState)({}), id = _useState3[0];
  var onActivation = (0, import_react104.useCallback)(function(_ref2) {
  ...
  var onDeactivation = (0, import_react104.useCallback)(function() {
  ...
  var returnFocus = (0, import_react104.useCallback)(function(allowDefer) {
  ...
  var onFocus3 = (0, import_react104.useCallback)(function(event) {
    if (isActive.current) {
      mediumFocus.useMedium(event);
    }
  }, []);
  var onBlur3 = mediumBlur.useMedium;
  var setObserveNode = (0, import_react104.useCallback)(function(newObserved) {
  ...
  var focusScopeValue = (0, import_react104.useMemo)(function() {
    return {
      observed,
      shards,
      enabled: !disabled,
  ...
  return import_react104.default.createElement(import_react104.Fragment, null, hasLeadingGuards && [
    ...
    hasPositiveIndices ? import_react104.default.createElement("div", {
      key: "guard-nearest",
      "data-focus-guard": true,
      tabIndex: disabled ? -1 : 1,
      style: hiddenGuard
    }) : null
  ], !disabled && import_react104.default.createElement(SideCar2, {
    id,
    ...
    focusOptions,
    noFocusGuards
  }), import_react104.default.createElement(Container3, _extends({
    ref: mergedRef
  }, lockProps, {
    className,
    onBlur: onBlur3,
    onFocus: onFocus3
  }), import_react104.default.createElement(focusScope.Provider, {
    value: focusScopeValue
  }, children)), hasTailingGuards && import_react104.default.createElement("div", {
    "data-focus-guard": true,
    tabIndex: disabled ? -1 : 0,
    style: hiddenGuard
  }));
  ...
  return function wrap5(WrappedComponent) {
    ...
    var SideEffect = function(_PureComponent) {
      ...
      _proto.render = function render() {
        return import_react105.default.createElement(WrappedComponent, this.props);
      };
      return SideEffect2;
    }(import_react105.PureComponent);
...
// node_modules/react-focus-lock/dist/es2015/Combination.js
var FocusLockCombination = (0, import_react107.forwardRef)(function FocusLockUICombination(props, ref) {
  return import_react107.default.createElement(Lock_default, _extends({
...
var AutoFocusInside = function AutoFocusInside2(_ref2) {
  ...
  return import_react108.default.createElement("div", _extends({}, inlineProp(FOCUS_AUTO, !disabled), {
    className
  }), children);
};
...
function MoveFocusInside(_ref2) {
  ...
  var ref = (0, import_react109.useRef)(null);
  useFocusInside(isDisabled ? void 0 : ref);
  return import_react109.default.createElement("div", _extends({}, inlineProp(FOCUS_AUTO, !isDisabled), {
    ref,
    className
  }), children);
}
...
var FreeFocusInside = function FreeFocusInside2(_ref2) {
  ...
  return import_react110.default.createElement("div", _extends({}, inlineProp(FOCUS_ALLOW, true), {
    className
  }), children);
};
...
var FocusLock2 = (props) => {
  ...
  const onActivation = (0, import_react113.useCallback)(() => {
  ...
  const onDeactivation = (0, import_react113.useCallback)(() => {
    var _a8;
...
function useHighlight(props) {
  ...
  return (0, import_react114.useMemo)(() => highlightWords({ text, query }), [text, query]);
}
...
function Highlight(props) {
  ...
  return (0, import_jsx_runtime80.jsx)(import_jsx_runtime80.Fragment, { children: chunks.map((chunk, index) => {
    return chunk.match ? (0, import_jsx_runtime80.jsx)(Mark, { sx: styles2, children: chunk.text }, index) : (0, import_jsx_runtime80.jsx)(import_react115.Fragment, { children: chunk.text }, index);
  }) });
}
...
function createIcon(options) {
  ...
  const path = import_react116.Children.toArray(options.path);
...
var Indicator = forwardRef6(
  function Indicator2(props, ref) {
    ...
    const styles2 = (0, import_react117.useMemo)(
      () => ({
        display: "inline-flex",
        justifyContent: "center",
        alignItems: "center",
...
function useMediaQuery(query, options = {}) {
  ...
  const [value, setValue] = (0, import_react119.useState)(() => {
...
function useShortcut(props = {}) {
  ...
  const [keys2, setKeys] = (0, import_react120.useState)([]);
  const timeoutRef = (0, import_react120.useRef)(void 0);
  const flush = () => {
  ...
  (0, import_react120.useEffect)(() => flush, []);
...
function usePopper(props = {}) {
  ...
  const reference2 = (0, import_react121.useRef)(null);
  const popper2 = (0, import_react121.useRef)(null);
  const instance = (0, import_react121.useRef)(null);
  const placement = getPopperPlacement(placementProp, direction2);
  const cleanup = (0, import_react121.useRef)(() => {
  });
  const setupPopper = (0, import_react121.useCallback)(() => {
    var _a8;
  ...
  const referenceRef = (0, import_react121.useCallback)(
    (node3) => {
  ...
  const getReferenceProps = (0, import_react121.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const popperRef = (0, import_react121.useCallback)(
    (node3) => {
  ...
  const getPopperProps = (0, import_react121.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const getArrowProps = (0, import_react121.useCallback)((props2 = {}, ref = null) => {
  ...
  const getArrowInnerProps = (0, import_react121.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      ref,
      "data-popper-arrow-inner": ""
...
function useEventListeners() {
  const listeners = (0, import_react122.useRef)(/* @__PURE__ */ new Map());
  const currentListeners = listeners.current;
  const add3 = (0, import_react122.useCallback)((el, type, listener, options) => {
    listeners.current.set(listener, { type, el, options });
    el.addEventListener(type, listener, options);
  }, []);
  const remove = (0, import_react122.useCallback)(
...
function useClickable(props = {}) {
  ...
  const [isButton, setIsButton] = (0, import_react123.useState)(true);
  const [isPressed, setIsPressed] = (0, import_react123.useState)(false);
  ...
  const onDocumentKeyUp = (0, import_react123.useCallback)(
    (e) => {
  ...
  const handleKeyUp = (0, import_react123.useCallback)(
    (event) => {
  ...
  const onDocumentMouseUp = (0, import_react123.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      setIsPressed(false);
  ...
  const handleMouseDown = (0, import_react123.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      if (isDisabled) {
  ...
  const handleMouseUp = (0, import_react123.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      if (!isButton) {
  ...
  const handleMouseOver = (0, import_react123.useCallback)(
    (event) => {
      if (isDisabled) {
        event.preventDefault();
        return;
  ...
  const handleMouseLeave = (0, import_react123.useCallback)(
    (event) => {
      if (isPressed) {
        event.preventDefault();
        setIsPressed(false);
...
function useMenu(props = {}) {
  ...
  const menuRef = (0, import_react124.useRef)(null);
  const buttonRef = (0, import_react124.useRef)(null);
  const scrollIntoViewRef = (0, import_react124.useRef)(true);
  const descendants = useMenuDescendants();
  const focusMenu = (0, import_react124.useCallback)(() => {
    requestAnimationFrame(() => {
      var _a8;
      (_a8 = menuRef.current) == null ? void 0 : _a8.focus({ preventScroll: false });
    });
  }, []);
  const focusFirstItem = (0, import_react124.useCallback)(() => {
  ...
  const focusLastItem = (0, import_react124.useCallback)(() => {
    const id2 = setTimeout(() => {
      var _a8;
  ...
  const onOpenInternal = (0, import_react124.useCallback)(() => {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react124.useState)(-1);
  ...
  const openAndFocusMenu = (0, import_react124.useCallback)(() => {
    onOpen();
    focusMenu();
  }, [onOpen, focusMenu]);
  const timeoutIds = (0, import_react124.useRef)(/* @__PURE__ */ new Set([]));
  ...
  const openAndFocusFirstItem = (0, import_react124.useCallback)(() => {
    onOpen();
    focusFirstItem();
  }, [focusFirstItem, onOpen]);
  const openAndFocusLastItem = (0, import_react124.useCallback)(() => {
    scrollIntoViewRef.current = true;
    onOpen();
    focusLastItem();
  }, [onOpen, focusLastItem]);
  const refocus = (0, import_react124.useCallback)(() => {
    var _a8, _b3;
...
function useMenuList(props = {}, ref = null) {
  ...
  const hasBeenOpened = (0, import_react124.useRef)(false);
  if (isOpen) {
...
function useMenuItem(props = {}, externalRef = null) {
  ...
  const id = `${menuId}-menuitem-${(0, import_react124.useId)()}`;
  const { index, register } = useMenuDescendant({
    disabled: isDisabled && !isFocusable2
  });
  const onMouseEnter = (0, import_react124.useCallback)(
    (event) => {
  ...
  const onMouseMove = (0, import_react124.useCallback)(
    (event) => {
  ...
  const onMouseLeave = (0, import_react124.useCallback)(
    (event) => {
  ...
  const onClick = (0, import_react124.useCallback)(
    (event) => {
  ...
  const onFocus3 = (0, import_react124.useCallback)(
    (event) => {
...
function useMenuOptionGroup(props = {}) {
  ...
  const clones = validChildren.map((child) => {
    ...
    return (0, import_react124.cloneElement)(child, {
      type,
      onClick,
      isChecked
    });
...
var MenuIcon = (props) => {
  ...
  const clone = (0, import_react126.isValidElement)(child) ? (0, import_react126.cloneElement)(child, {
    focusable: "false",
    "aria-hidden": true,
...
var StyledMenuItem = forwardRef6(
  (props, ref) => {
    ...
    const buttonStyles = (0, import_react127.useMemo)(
      () => ({
        textDecoration: "none",
        color: "inherit",
        userSelect: "none",
...
function useModalManager(ref, isOpen) {
  const [index, setIndex] = (0, import_react128.useState)(0);
...
function useModal(props) {
  ...
  const getDialogProps = (0, import_react129.useCallback)(
    (props2 = {}, ref = null) => ({
      role: "dialog",
      ...props2,
  ...
  const onOverlayClick = (0, import_react129.useCallback)(
    (event) => {
      event.stopPropagation();
  ...
  const getDialogContainerProps = (0, import_react129.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
...
var SlideFade = (0, import_react131.forwardRef)(
...
var ScaleFade = (0, import_react132.forwardRef)(
...
var ModalTransition = (0, import_react133.forwardRef)(
  (props, ref) => {
...
var Fade = (0, import_react136.forwardRef)(
...
var Slide = (0, import_react137.forwardRef)(
...
function useNumberInput(props = {}) {
  ...
  const sanitize = (0, import_react140.useCallback)(
    (value) => value.split("").filter(isValidCharacter).join(""),
    [isValidCharacter]
  );
  const parse4 = (0, import_react140.useCallback)(
...
function PinInput(props) {
  ...
  const clones = getValidChildren(children).map(
    (child) => (0, import_react143.cloneElement)(child, { __css: styles2 })
  );
...
function usePopover(props = {}) {
  ...
  const [restoreFocus, setRestoreFocus] = (0, import_react144.useState)(returnFocusOnClose);
  (0, import_react144.useEffect)(() => setRestoreFocus(returnFocusOnClose), [returnFocusOnClose]);
  const anchorRef = (0, import_react144.useRef)(null);
  const triggerRef = (0, import_react144.useRef)(null);
  const popoverRef = (0, import_react144.useRef)(null);
  const isHoveringRef = (0, import_react144.useRef)(false);
  const hasBeenOpened = (0, import_react144.useRef)(false);
  if (isOpen) {
    hasBeenOpened.current = true;
  }
  const [hasHeader, setHasHeader] = (0, import_react144.useState)(false);
  const [hasBody, setHasBody] = (0, import_react144.useState)(false);
  ...
  const getPopoverProps = (0, import_react144.useCallback)(
    (props2 = {}, _ref2 = null) => {
      const popoverProps = {
        ...props2,
        style: {
  ...
  const getPopoverPositionerProps = (0, import_react144.useCallback)(
  ...
  const getAnchorProps = (0, import_react144.useCallback)(
    (props2, _ref2 = null) => {
      return {
        ...props2,
  ...
  const openTimeout = (0, import_react144.useRef)(void 0);
  const closeTimeout = (0, import_react144.useRef)(void 0);
  const maybeReferenceRef = (0, import_react144.useCallback)(
    (node3) => {
  ...
  const getTriggerProps = (0, import_react144.useCallback)(
    (props2 = {}, _ref2 = null) => {
      const triggerProps = {
        ...props2,
  ...
  const getHeaderProps = (0, import_react144.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      id: headerId,
  ...
  const getBodyProps = (0, import_react144.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      id: bodyId,
      ref: mergeRefs(ref, (node3) => {
...
function getElementRef(el) {
  var _a8;
  const version2 = React25.version;
...
function PopoverAnchor(props) {
  const child = import_react145.Children.only(props.children);
  const { getAnchorProps } = usePopoverContext();
  return (0, import_jsx_runtime127.jsx)(import_jsx_runtime127.Fragment, { children: (0, import_react145.cloneElement)(child, getAnchorProps(child.props, getElementRef(child))) });
}
...
function PopoverTrigger(props) {
  ...
  return (0, import_jsx_runtime135.jsx)(import_jsx_runtime135.Fragment, { children: (0, import_react146.cloneElement)(child, getTriggerProps(child.props, getElementRef(child))) });
}
...
function useRadioGroup(props = {}) {
  ...
  const [valueState, setValue] = (0, import_react148.useState)(defaultValue || "");
  const isControlled = typeof valueProp !== "undefined";
  const value = isControlled ? valueProp : valueState;
  const ref = (0, import_react148.useRef)(null);
  const focus = (0, import_react148.useCallback)(() => {
  ...
  const getRootProps = (0, import_react148.useCallback)(
    (props2 = {}, forwardedRef = null) => ({
      ...props2,
  ...
  const getRadioProps = (0, import_react148.useCallback)(
    (props2 = {}, ref2 = null) => {
      const checkedKey = isNative ? "checked" : "isChecked";
      return {
        ...props2,
...
var RadioGroup = forwardRef6((props, ref) => {
  ...
  const group = (0, import_react149.useMemo)(
    () => ({
      name,
      size: size2,
      onChange,
...
function useRadio(props = {}) {
  ...
  const uuid = `radio-${(0, import_react150.useId)()}`;
  ...
  const [isHovered, setHovering] = (0, import_react150.useState)(false);
  const [isActive, setActive] = (0, import_react150.useState)(false);
  const [isCheckedState, setChecked] = (0, import_react150.useState)(Boolean(defaultChecked));
  const isControlled = typeof isCheckedProp !== "undefined";
  const isChecked = isControlled ? isCheckedProp : isCheckedState;
  const isFocusVisibleRef = (0, import_react150.useRef)(false);
  ...
  const onKeyUp = (0, import_react150.useCallback)(
    (event) => {
      if (event.key === " ") {
        setActive(false);
      }
...
var SelectIcon = (props) => {
  ...
  const clone = (0, import_react151.cloneElement)(children, {
    role: "presentation",
  ...
  return (0, import_jsx_runtime144.jsx)(IconWrapper, { ...rest, className: "chakra-select__icon-wrapper", children: (0, import_react151.isValidElement)(children) ? clone : null });
};
...
function useIsFirstRender() {
  const isFirstRender = (0, import_react152.useRef)(true);
...
function useRangeSlider(props) {
  ...
  const [isDragging, setDragging] = (0, import_react154.useState)(false);
  const [isFocused, setFocused] = (0, import_react154.useState)(false);
  const [activeIndex, setActiveIndex] = (0, import_react154.useState)(-1);
  const isInteractive = !(isDisabled || isReadOnly);
  const initialValue = (0, import_react154.useRef)(valueState);
  ...
  const actions = (0, import_react154.useMemo)(
    () => ({
  ...
  const { getThumbStyle, rootStyle, trackStyle, innerTrackStyle } = (0, import_react154.useMemo)(
    () => getStyles3({
      isReversed,
      orientation,
      thumbPercents
  ...
  const focusThumb = (0, import_react154.useCallback)(
    (index) => {
      var _a8;
  ...
  const getTrackProps = (0, import_react154.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
  ...
  const getInnerTrackProps = (0, import_react154.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
  ...
  const getThumbProps = (0, import_react154.useCallback)(
    (props2, ref = null) => {
      const { index, ...rest } = props2;
  ...
  const getOutputProps = (0, import_react154.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
  ...
  const getMarkerProps = (0, import_react154.useCallback)(
    (props2, ref = null) => {
...
var RangeSlider = forwardRef6(
  function RangeSlider2(props, ref) {
    ...
    const ctx = (0, import_react155.useMemo)(
...
function useSlider(props) {
  ...
  const thumbRef = (0, import_react156.useRef)(null);
  ...
  const constrain = (0, import_react156.useCallback)(
    (value2) => {
      const state22 = stateRef.current;
...
var Stack = forwardRef6((props, ref) => {
  ...
  const dividerStyle = (0, import_react157.useMemo)(
    () => getDividerStyles({ spacing: spacing2, direction: direction2 }),
    [spacing2, direction2]
  );
  const hasDivider = !!divider;
  const shouldUseChildren = !shouldWrapChildren && !hasDivider;
  const clones = (0, import_react157.useMemo)(() => {
    const validChildren = getValidChildren(children);
    return shouldUseChildren ? validChildren : validChildren.map((child, index) => {
      ...
      if (!hasDivider)
        return _child;
      const clonedDivider = (0, import_react157.cloneElement)(
        divider,
        {
          __css: dividerStyle
        }
      ...
      return (0, import_jsx_runtime152.jsxs)(import_react157.Fragment, { children: [
        _child,
        _divider
      ] }, key);
    });
...
var Stepper = forwardRef6(function Stepper2(props, ref) {
  ...
  const stepElements = import_react158.Children.toArray(children);
...
function useSteps(props = {}) {
  ...
  const [activeStep, setActiveStep] = (0, import_react159.useState)(index);
...
var Switch = forwardRef6(
  function Switch2(props, ref) {
    ...
    const containerStyles = (0, import_react160.useMemo)(
      () => ({
        display: "inline-block",
        position: "relative",
        verticalAlign: "middle",
    ...
    const trackStyles = (0, import_react160.useMemo)(
      () => ({
        display: "inline-flex",
        flexShrink: 0,
    ...
    const labelStyles = (0, import_react160.useMemo)(
      () => ({
        userSelect: "none",
        marginStart: spacing2,
        ...styles2.label
...
function useTabs(props) {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react161.useState)(defaultIndex ?? 0);
...
function useTabPanels(props) {
  ...
  const children = validChildren.map(
    (child, index) => (0, import_react161.createElement)(
      TabPanelProvider,
      {
        key: child.key ?? index,
        value: {
...
function useTabPanel(props) {
  ...
  const hasBeenSelected = (0, import_react161.useRef)(false);
  if (isSelected) {
...
function useTabIndicator() {
  ...
  const isHorizontal = orientation === "horizontal";
  const isVertical = orientation === "vertical";
  const [rect, setRect] = (0, import_react161.useState)(() => {
    if (isHorizontal)
  ...
  const [hasMeasured, setHasMeasured] = (0, import_react161.useState)(false);
  useSafeLayoutEffect(() => {
...
var Tabs = forwardRef6(function Tabs2(props, ref) {
  ...
  const context = (0, import_react162.useMemo)(() => ctx, [ctx]);
...
function useTooltip(props = {}) {
  ...
  const enterTimeout = (0, import_react164.useRef)(void 0);
  ...
  const exitTimeout = (0, import_react164.useRef)(void 0);
...
var Tooltip = forwardRef6((props, ref) => {
  ...
  const shouldWrap = !(0, import_react165.isValidElement)(children) || shouldWrapChildren;
  let trigger2;
  if (shouldWrap) {
...
var Wrap = forwardRef6(function Wrap2(props, ref) {
  ...
  const _children = (0, import_react166.useMemo)(
    () => shouldWrapChildren ? import_react166.Children.map(children, (child, index) => (0, import_jsx_runtime194.jsx)(WrapItem, { children: child }, index)) : children,
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-VCV2GFPP.js.map
